...
class AllBankRefreshHBM3 : public IRefreshManager, public Implementation {
  RAMULATOR_REGISTER_IMPLEMENTATION(IRefreshManager, AllBankRefreshHBM3, "AllBankHBM3", "All-Bank Refresh scheme for HBM3.")
  private:
    Clk_t m_clk = 0;
    IDRAM* m_dram;
